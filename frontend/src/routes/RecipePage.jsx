  ...
  return (
    <div className="w-screen min-h-screen flex flex-col justify-start items-center text-center">
      <div className="w-full pt-10 flex flex-col justify-center items-center">
        <h1 className="text-6xl font-bold text-black mb-8 hover:scale-[1.2] transition-all duration-200 ease-in-out hover:cursor-pointer" onClick={hanldeBackToHome}>Recipes</h1>
